...
## **Design Mechanisms**
The mechanics for accretive token issuance built on the ERC20 fungible token standard [link] (https://theethereum.wiki/w/index.php/ERC20_Token_Standard "Title") and are straightforward:  
